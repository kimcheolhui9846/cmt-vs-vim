...
rather than from transcribed values. The repository is public at
\url{https://github.com/kimcheolhui9846/cmt-vs-vim}. It contains the code, the
committed measurement files, and the full commit history of the work; it does
not reproduce the text of the earlier version cited in the footnote in
