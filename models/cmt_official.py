...
# https://github.com/huawei-noah/Efficient-AI-Backbones/blob/master/cmt_pytorch/cmt.py
# Retrieved: 2026-08-18. Imports intentionally left on timm 0.x paths
# (timm.models.helpers / timm.models.layers / timm.models.registry) — the
# pinned measurement environment uses timm 0.9.12, where these are the
# canonical import paths. Under timm 1.0.28 they still resolve via
# deprecation shims (expect FutureWarnings). Do not "modernize" these
# imports; doing so would break the file in the pinned environment.
