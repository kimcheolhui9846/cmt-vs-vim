...
이 저장소가 "논문 v1"이라고 부르는 것은 저자들 본인의 다음 논문이다.

> 김철희, 이강국, 심규성, 「CMT와 Vision Mamba의 심층 비교 분석: CNN-Transformer
> 하이브리드와 상태공간 모델의 원리적 대비」, 2026 대한전자공학회 하계종합학술대회,
> GEP-0563 (포스터 P4-44), 2026.

전문은 DBpia에 게재될 예정이다. 게재 논문의 저작권은 대한전자공학회에 귀속된다
(논문투고규정 제22조). `docs/paper-v1.pdf`는 개정 작업의 대조본으로 이력에 남아
있는 저자 원고이며, 이 저장소의 어떤 문서도 논문 본문을 옮겨 싣지 않는다 —
인용한 문장과 표 값은 전부 위 논문을 출처로 밝힌다.
