...
v1은 2026-05-15에 대한전자공학회에 제출을 마쳤다. v2는 특정 투고처를 겨냥하지
않으며 마감일도 없다. 따라서 페이지 상한 제약이 없고, E3를 지면 문제로 부록에
밀어낼 이유도 없다. E3의 우선순위가 낮은 것은 구현 난이도 때문이지 분량 때문이
아니다.

일정은 외부 마감이 아니라 자체 목표(1~2개월)로 관리한다.
